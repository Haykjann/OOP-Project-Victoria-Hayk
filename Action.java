...
public class Action {
    ...
    public void Move (Player x, GameBoard y) {
        dice = j.nextInt(11) + 2;
    ...
    public void Buy (Player x, GameBoard z) {
    ...
    public void payRent (Player x, Player y, GameBoard z) {
    ...
    public void getPlayersStatus (Player x, Player y) {
        System.out.println();
        System.out.println(x.toString());
        System.out.println(y.toString());
    }
    public void checkForWinner (Player x, Player y) {
        if (x.getMoney() < 0) {
            getPlayersStatus (x, y);
